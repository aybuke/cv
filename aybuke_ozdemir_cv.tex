...
\vspace*{+.05in}
\begin{list2}
\item AWS, Azure ve Google Cloud \"{u}zerinde \c{c}al{\i}\c{s}ma f{\i}rsat{\i}m oldu. Bir\c{c}ok cloud servisi d{\i}\c{s}{\i}nda kubernetes, terraform gibi teknolojileri kulland{\i}m.
\end{list2}
...
\item Programlama: Python, C/C++, {\em biraz Perl ve Ruby}.
